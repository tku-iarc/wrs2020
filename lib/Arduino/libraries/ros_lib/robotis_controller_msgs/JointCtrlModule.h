#ifndef _ROS_robotis_controller_msgs_JointCtrlModule_h
#define _ROS_robotis_controller_msgs_JointCtrlModule_h
...
namespace robotis_controller_msgs
{
  ...
  class JointCtrlModule : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "robotis_controller_msgs/JointCtrlModule"; };
